...
// Interface → structure d'un projet
...
export class ProjectsService {
  ...
  // GET /api/projects → tous les projets (SuperAdmin)
  ...
  create(name: string, description: string, portfolioDirectorId: string): Observable<any> {
